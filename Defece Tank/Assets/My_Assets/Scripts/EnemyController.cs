...
public class EnemyController : MonoBehaviour {
    ...
    public float idle_For_This_Time = 5f;
    ...
    void OnEnable()
    {
        ...
        //  playercontrollers = target.GetComponent<playercontroller>();
	...
	void Update () {
        ...
        {
            target = GameManager_Defence.Instance.player;
            ...
            {
                if (GameManager_Defence.Instance.player.GetComponent<Player_Tank>().health > 0 && Game.gameStatus == Game.GameStatus.isPlaying)
                {
                    Attack();
                }
            }
   ...
   public void Chase() {
    ...
    void Attack() {
        //player_Health = target.GetComponent<Player_Health>();
    ...
    void MakeDamage()
    {
        GameManager_Defence.Instance.player.GetComponent<Player_Tank>().ApplyDamage(1);
    }
