...
Shader Sandwich Shader
	...
	Begin Shader Base
		...
		Begin Shader Input
			Type(Text): "Color"
			VisName(Text): "Color"
			Color(Vec): 0.7720588,0.7720588,0.7720588,1
		...
		ShaderName(Text): "Shader Sandwich/Tutorials/Diffuse"
		Tech Lod(Float): 200
			...
			Begin Shader Ingredient
				...
				Begin Shader Layer List
					...
					Begin Shader Layer
						...
						Cubemap(Cubemap): asshobitch
						Noise Dimensions(Type): SSN/A - {TypeID = 0}
						Color(Vec): 0.7720588,0.7720588,0.7720588,1 - {Input = 0}
						Color 2(Vec): 0,0,0,1
						Texture(Texture): assho
						Jitter(Float): 0
						Fill(Float): 0
						MinSize(Float): 0
						Edge(Float): 1
