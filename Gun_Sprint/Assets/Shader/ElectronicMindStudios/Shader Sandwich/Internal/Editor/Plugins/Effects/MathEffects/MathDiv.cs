...
[System.Serializable]
public class SSEMathDiv : ShaderEffect{
	public override void Activate(){
		TypeS = "SSEMathDiv";
		Name = "Maths/Divide";//+UnityEngine.Random.value.ToString();
		shader = "Hidden/ShaderSandwich/Previews/Effects/Maths/Div";
		Function = "";
		LinePre = "";
		
			Inputs = new SVDictionary();
			Inputs.Add(new ShaderVar("Divide",1));

		Inputs["Divide"].NoSlider = true;


	
	}
	public override string Generate(ShaderData SD, ShaderLayer SL, SVDictionary Inputs, string Line, ShaderLayerBranch Branch){
		return "("+Line+"/"+Inputs["Divide"].Get()+")";
	}
