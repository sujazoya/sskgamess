...
[System.Serializable]
public class SSESwitchNormalScale2 : ShaderEffect{
	public override void Activate(){
		TypeS = "SSESwitchNormalScale2";
		Name = "Conversion/Stretch Normal Map";//+UnityEngine.Random.value.ToString();
		shader = "Hidden/ShaderSandwich/Previews/Effects/SwitchNormalMapScale2";
		
		Function = "";
		LinePre = "";	
	}
	public override string Generate(ShaderData SD, ShaderLayer SL, SVDictionary Inputs, string Line, ShaderLayerBranch Branch){
		return "(("+Line+"-0.5)*2)";///2+0.5)";
	}
