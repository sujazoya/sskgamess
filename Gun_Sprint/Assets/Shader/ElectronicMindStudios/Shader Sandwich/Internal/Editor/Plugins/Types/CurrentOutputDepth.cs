...
namespace ElectronicMind.Sandwich{
	[System.Serializable]
	public class SLTCurrentOutputDepth : ShaderLayerType{
		override public void Activate(){
			TypeS = "SLTCurrentOutputDepth";
			Name = "Screen/Depth";
			MenuIndex = 19;
			Description = "The current depth this pixel.";
		...
		public override void GPUPreviewJustBefore(SVDictionary Inputs, ShaderLayer SL, RenderTexture In, RenderTexture Out){
			_Material.SetTexture("Texture",ShaderSandwich.ThisDepthThing);
		}
		public Color[] Image;
		...
		override public ShaderColor Preview(SVDictionary Data, ShaderLayer SL, Vector2 UV, ShaderColor[] OldColors, ShaderColor OldColor){
			...
			if (ShaderSandwich.ThisDepthThing!=null)
				Image = ShaderSandwich.ThisDepthThing.GetPixels(0);
