...
/// </summary>
public class GameExampleSceneState : FSMState<GameManager>
{
    private ExampleSceneManager scene;

    public GameExampleSceneState() { }

    public override void Enter(GameManager owner)
    {
        Debug.Log("Entered Game STW State");

        scene = (ExampleSceneManager)GameObject.Instantiate(owner.scene);
