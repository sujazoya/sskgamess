...
public class GoogleSheetHandler
{
    ...
    public static string open_id_1;
    public static string open_id_2;
    public static string open_id_3;
    ...
    public static bool show_open_1;
    public static bool show_open_2;
    public static bool show_open_3;
...
//FACEBOOK
    ...
    public static void GetDataFromAPI(string snapshot)
    {
        ...
        #region AD'S SECTION
            ...
            #region OPEN AD
            show_open_1 = BooleanChecker(info["show_open"].Value);
            show_open_2 = BooleanChecker(info1["show_open"].Value);
            show_open_3 = BooleanChecker(info2["show_open"].Value);
            open_id_1      = info["open_id"].Value.ToString();
            open_id_2      = info1["open_id"].Value.ToString();
            open_id_3      = info2["open_id"].Value.ToString();
